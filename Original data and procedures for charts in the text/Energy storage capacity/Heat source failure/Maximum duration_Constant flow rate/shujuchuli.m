...
figure;
set(gcf, 'unit', 'centimeters', 'position', [10 10 20 18]); % Adjust figure size
...
hl.ItemTokenSize = [30,30];

% print('PS变温_流速比4', '-dpng', '-r600');  % Save as PNG with 300 dpi
% saveas(gcf, 'PS变温_流速比4.fig')
% close