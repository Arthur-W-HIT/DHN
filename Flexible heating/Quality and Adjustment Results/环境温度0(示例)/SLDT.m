...
set(gca, 'Position', [0.05, 0.22, 0.4,0.65]); % 调整左图位置和大小
...
set(pax1, 'Position', [0.05, 0.22, 0.4,0.65]); % 确保雷达图居中
...
title('(a)  Relative period -- variance')
set(gca, 'FontName', 'Times New Roman','FontSize',10);

%% 右图：绝对值雷达图
subplot(1,2,2); % 创建右边子图
set(gca, 'Position',[0.55, 0.22, 0.4,0.65]); % 调整右图位置和大小
...
set(pax2, 'Position', [0.55, 0.22, 0.4,0.65]); % 确保雷达图居中
...
title('(b)  Absolute expectation -- variance')
set(gca, 'FontName', 'Times New Roman','FontSize',10);
