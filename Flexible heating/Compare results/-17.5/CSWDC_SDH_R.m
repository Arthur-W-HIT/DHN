function [SDH_R_T_CS,SDH_R_RHL]=CSWDC_SDH_R(T_s,SDH_R_T_in_o,SDH_L,SDH_V_w,SDH_u,SDH_d,SDH_D,SDH_A,SDH_alpha_tt,alpha_w,rou_w,Cp_w,SDH_nx,nt,SDH_dx,dt)
T = T_s(1)* ones(SDH_nx, 1); % 初始温度场
SDH_R_T_in =SDH_R_T_in_o*ones(1,nt);           % 入口温度 (摄氏度)
% 创建存储温度随时间变化的数据
