function [PDH_R_T_CS,PDH_R_RHL]=CSWDC_PDH_R(T_s,PDH_R_T_in_o,PDH_L,PDH_V_w,PDH_u,PDH_d,PDH_D,PDH_A,PDH_alpha_tt,alpha_w,rou_w,Cp_w,PDH_nx,nt,PDH_dx,dt)
T = T_s(1)* ones(PDH_nx, 1); % 初始温度场
PDH_R_T_in =PDH_R_T_in_o*ones(1,nt);           % 入口温度 (摄氏度)
% 创建存储温度随时间变化的数据
